...
"""we are importing only the required files i.e cat and readfile from a different file in same directory i.e lib.helper in our case."""
...
"""condition : if value of ARG_CNT is greater than 1, then it exectues the print statement with the error message"""

if ARG_CNT > 1:
    print(sys.argv[0], "doesn't handle more than one argument")

"""the print statement here calls a function cat which takes a TEXT variable as an argument"""
