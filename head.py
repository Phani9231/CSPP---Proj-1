...
"""we are importing only the required files i.e head and readfile from a different file in same directory i.e lib.helper in our case."""
...
"""the print statement here calls a function head which takes a TEXT variable as an argument"""
