...
"""we are importing only the required files i.e tail and readfile from a different file in same directory i.e lib.helper in our case."""
...
"""the print statement here calls a function tail which takes a TEXT variable as an argument"""
